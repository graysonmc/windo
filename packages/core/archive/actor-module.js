...
/**
 * ActorModule - AI conversation processor for student interactions
 *
 * Handles the Actor layer of the NSM architecture:
 * - Processes student messages with GPT-4
 * - Builds dynamic system prompts
 * - Evaluates actor triggers
 * - Manages document context integration
 *
 * This module is stateless - all state management is handled by the API layer.
 */
class ActorModule {
  constructor() {
